...
L.Control.Velocity = L.Control.extend({
  ...
  _onClick: function _onClick(e) {
    ...
    if (gridValue && !isNaN(gridValue[0]) && !isNaN(gridValue[1]) && gridValue[2]) {
      ...
      console.log( cardinal.concat(this.options.velocityType, " ").concat(this.options.directionString, ": ").concat(deg.toFixed(2), "\xB0").concat(cardinal, ", ").concat(this.options.velocityType, " ").concat(this.options.speedString, ":").concat(self.vectorToSpeed(gridValue[0], gridValue[1], this.options.speedUnit).toFixed(2), " ").concat(this.options.speedUnit));
    }
  },
...
var Windy = function Windy(params) {
  ...
  var PARTICLE_MULTIPLIER = params.particleMultiplier || 1 / 1000; // particle count scalar (completely arbitrary--this values looks nice)
  ...
  //var defaulColorScale = ["rgb(255,255, 255)", "rgb(255,255, 255)", "rgb(255,255,255 )", "rgb(255,255,255 )", "rgb(255,255,255)", "rgb(255,255,255)", "rgb(255,255,255)", "rgb(255,255,255)", "rgb(255,255,255)", "rgb(255,255,255)", "rgb(255,255,255)", "rgb(255,255,255)", "rgb(255,255,255)", "rgb(255,255,255)", "rgb(255,255,255)"];
  var defaulColorScale = ["rgb(255,255,255)"];
