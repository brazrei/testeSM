...
function plotaMarca(lat, lng, loc) {
    ...
    if (!isNaN(lat) && !isNaN(lng)) {
        ...
        var svgIcon = new L.divIcon({//vento trovoada teto visib
            // Specify a class name we can refer to in CSS.
            className: 'css-icon',
            html: `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="599" height="127" viewBox="0 0 599 127" xml:space="preserve">
