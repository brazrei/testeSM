...
var localidadesFIR = [
    ...
    "SBAN, SBBH, SBBR, SBBW, SBCF, SBCN, SBGO, SBIP, SBIT, SBLS, SBMK, SBNV, SBPJ, SBPR, SBYS, SBAQ, SBAX, SBBP, SBGP, SBJD, SBKP,SBSJ, SBPC, SBRP, SBSR, SBUL, SBUR, SBVG, SNDV, SDAM, SWLC,SBML,SBBU,SBAE,SBAU,SNPD",
...
var arrayCMA = [
    ...
    "SBBR = SBAN SBBH SBBR SBBW SBCF SBCN SBGO SBIP SBIT SBLS SBMK SBNV SBPJ SBPR SBYS SWLC SNPD",
    ...
    "SBPA = SBAE SBAF SBAU SBBG SBBI SBBU SBCA SBCD SBCG SBCH SBCO SBCR SBCT SBCX SBDB SBDN SBDO SBFI SBFL SBGU SBGW SBJA SBJV SBLJ SBLO SBMG SBML SBNF SBNM SBPA SBPF SBPG SBPK SBPO SBPP SBSC SBSM SBTD SDCO SBTG SBUG SSGG SNCP",
...
function strToCell(arr, idxFIR, novo, naoAdiciona, onLine = true) {//nãoadiciona significa substituir(apagar o anterior)
    ...
    try {
        if (arr && arr[2] && !arr[2].maisRecente || (cma == "ESTRANGEIRA"))
            classe += " linhaInativa"
    } catch (e) {
